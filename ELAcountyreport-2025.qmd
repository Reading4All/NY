...
fig2 = {
  ...
  return Plot.plot({
    ...
    (x%) = % Proficient = (#Proficient/# in Cohort)*100`,
...
fig3 = {
  ...
  return Plot.plot({
    ...
    marginBottom: 40,
    style: { fontSize: "14px" },
    title: `Equity Gap, %Proficient (${cohortPlot2_shortshort} - ${cohortPlot1_shortshort})`,
    subtitle: `County: ${inputSels.county}, Grade: ${inputSels.grade.slice(3)}, Year-ending: ${shared_data[0].YEAR}`,
    caption: html`Data Source: <a href="https://data.nysed.gov/downloads.php">NYSED Report Card Database</a><br>
      Bar opacity reflects ${cohortPlot2_short} test participation — lighter bar = higher opt-out rate`,
    x: { label: "Percentage point gap", labelAnchor: "center", labelArrow: "none" },
    ...
    marks: [
      ...
      <!--   x: 100, -->
      <!--   y: d => d.entity, -->
      <!--   text: d => `${d.optOutPct.toFixed(1)}% not tested`, -->
      <!--   fontSize: "10px", -->
      <!--   fill: "#B7BDC4", -->
      <!--   textAnchor: "start", -->
      <!--   dx: 5 -->
