...
@media (min-width: 768px) {
  /* 1. Hide the tab buttons entirely on desktop */
  .panel-tabset > .nav-tabs {
    display: none !important;
  }
  
  /* 2. Turn the container into a strict 2-column Grid */
  .panel-tabset > .tab-content {
    display: grid !important;
    /* This establishes exactly 2 equal columns side-by-side */
    grid-template-columns: repeat(2, minmax(0, 1fr)) !important;
    gap: 30px !important; /* Forces a safe horizontal gutter between columns */
    width: 100% !important;
  }
  
  /* 3. Force both sections to show up in their assigned columns */
  ...
  /* 4. Force the underlying OJS elements to stay within their grid lanes */
  .panel-tabset .tab-pane div, 
  .panel-tabset .tab-pane svg,
  .panel-tabset .tab-pane canvas {
    max-width: 100% !important;
  }
}
</style>
...
fig2 = {
  ...
  return Plot.plot({
    ...
    marks: [
      ...
      // Counts labels inside each bar segment
      Plot.text(segments, {
