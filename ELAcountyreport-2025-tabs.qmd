...
fig2 = {
  ...
  return Plot.plot({
    ...
    caption: html`Data Source (download files): <a href="https://data.nysed.gov/downloads.php">NYSED Report Card </a><br>
              Data Source (website): <a href="https://data.nysed.gov/">NYSED Report Card </a>`,
