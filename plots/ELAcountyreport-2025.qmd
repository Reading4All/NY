...
###### formating - Create county_desc for NYC districts from it's entity name
...
## then format the text - to just say the county name 
...
## then get rid of their ending " - county" also
